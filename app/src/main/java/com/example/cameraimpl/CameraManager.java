...
public class CameraManager {
    ...
    public CameraManager(Activity mActivity, TextureView mTextureView, ImageView mImageView) {
...
//            }
            ...
            mPreviewSize = getBestSize(exchange ? mPreviewSize.getHeight() : mPreviewSize.getWidth(),
                    ...
                    exchange ? mTextureView.getWidth() : mTextureView.getHeight(), Arrays.asList(previewSize));
            //此处预览的大小保持不变
...
//            val byteArray = ByteArray(byteBuffer.remaining())
    ...
    private static class CompareSizesByArea implements Comparator<Size> {
        ...
        public int compare(Size size, Size t1) {
            return java.lang.Long.signum((long) size.getWidth() * size.getHeight() - (long) t1.getWidth() * t1.getHeight());
        }
    }
}
